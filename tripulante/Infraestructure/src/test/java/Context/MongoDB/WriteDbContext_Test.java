...
public class WriteDbContext_Test {
  ...
  public void setUp() throws DataBaseException {
    ...
    Config.load("C:\\Users\\Liceth Flores\\Documents\\GitHub\\finalTesting\\tripulante\\config.properties");
    ...
    MongoCursor_ fakeCursor = new MongoCursor_(testDocuments);
  ...
  public void Single() throws Exception {
    DbSet a = new DbSet<>(context, IWriteDbContext.class.getField("Tripulacion"));
  ...
  public void Update() throws Exception {
    DbSet a = new DbSet<>(context, IWriteDbContext.class.getField("Tripulacion"));
    context.Update(new Tripulacion("Tripulacion"), (b -> true), a);
  }
